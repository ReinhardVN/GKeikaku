...
define config.name = _("Quel est notre premier souvenir")
...
define build.name = "Quelestnotrepremiersouvenir"
...
define config.save_directory = "Quelestnotrepremiersouvenir-1679926297"
